...
export function getExchange(data){
	return get({
		url:global.baseUrl + '/api/sv_voice/activate_exchange',
		data: data
	})
}

// 卡密剩余次数
export function getActivateResidueNumber(data){
	return get({
		url: global.baseUrl + '/api/sv_voice/get_activate_residue_number',
		data: data
...
// 数字人定制
export function postHumanCl(data){
	return post({
		url:global.baseUrl +'/api/sv_voice/short_video_digital_human_clone',
		data: data
	})
}

// 数字人定制
export function postDuration(data){
	return post({
		url:global.baseUrl +'/api/sv_voice/short_video_get_duration',
		data: data
	})
}

// 消费记录
export function activateConsume(data){
	return get({
		url:global.baseUrl +'/api/sv_voice/activate_consume',
		data: data
	})
}
...
export function getBusiness(data){
	return get({
		url:global.baseUrl +'/api/sv_voice/get_business',
		data: data
	})
}