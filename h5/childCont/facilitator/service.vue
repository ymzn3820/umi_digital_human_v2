...
<script>
	...
	export default {
		...
		methods: {
			...
			toEquity() {
				uni.navigateTo({
					url: '/childCont/facilitator/equity?level=3'
				})
			},
			toManage() {
				uni.navigateTo({
					url: '/childCont/facilitator/manage'
				})
			},
			toDeal() {
				uni.navigateTo({
					url: '/childCont/facilitator/deal'
				})
			},
			toBrokerage() {
				uni.navigateTo({
					url: '/childCont/facilitator/brokerage'
				})
			},

			toBank() {
				uni.navigateTo({
					url: '/childCont/distribution/cash',
				})
			},
			toExchange() {
				uni.navigateTo({
					url: '/childCont/distribution/Exchange',
				})
			},
		}
	}
